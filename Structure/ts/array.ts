var student1:string = "wasif ali"
var student2:string = "wasif ali"
var student3:string = "moazzam ali"
var student4:string = "wasif "


console.log(student1)
console.log(student2,student3,student4)

var students : string[] = ["wasif ali","wasif ali","moazzam ali","wasif "]
...
console.log(cars)
 ...
 var mixedStudents: (string | number )[] = ["Abu Hurairah","Anas","Bilal","Zahid",23]
 var anotherMixedStudents:(string | number)[] = ["Abu Hurairah"]
 
 var studentTuple:[string,(number|string),string]= ["Abu Hurairah", 23, "abuhurairah127@gmail.com"]
...
// [odd,even,odd,even,odd,odd,even,even.....]
 const function1_v2 = (num: number, ind: number): number => {
     return num * ind
 }
 ...
 const lengthFunction1 = (student:string):number => {
     return student.length
 }

 const lengthFunction2 = (student: string) => {
     if (student.length >= 5) {
         return true
    }
...
var arr3 = [9,78,55,88,88,77,45,12,21,23,52,52,45,55,5,55,55,74,48,89,56]
 ...
 const abc1 = (student:string,ind:number) => {
    if (ind % 2 ===0){
        return student.length
     }
    }
 ...
 const abc2 = (student:string,ind:number) => ind % 2 === 0 
